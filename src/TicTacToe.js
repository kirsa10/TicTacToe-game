...
const toggle=(e,num)=>{
 ...
 const won=(winner)=>{
  ...
  titleRef.current.appendChild(fireworks);
 }

 const reset=()=>{
  setLock(false);
  data=["","","","","","","","",""]
  titleRef.current.innerHTML='Tic Tac Toe <span>In</span>';
  box_array.map((e)=>{
    e.current.innerHTML="";
  })
 }
    ...
    return(
          <div className="container">
            <h1 className="title" ref={titleRef}><span>T</span>ic <span>T</span>ac <span>T</span>oe</h1>
            <div className="board">
              <div className="row1">
